...
export function chatFishery(message: string, lat: number, lon: number, sessionId?: string, signal?: AbortSignal) {
  ...
  return request<ChatResponse>('/chat-fishery', { method: 'POST', body, signal });
}
